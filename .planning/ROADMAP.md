...
Plans:
- [ ] 02-01-PLAN.md — Game foundation: types, puzzle data, state management, HTML page, game CSS, build integration
- [ ] 02-02-PLAN.md — Game rendering & input: DOM renderer, Pointer Events + keyboard navigation
