...
export const games: GameEntry[] = [
  ...
  },
  {
    slug: 'bubble-pop',
    name: 'Bubble Pop',
    description: 'Pop soap bubbles with your body! Move in front of your camera to burst colorful bubbles rising from below. Calming sensory play.',
    icon: '🫧',
    status: 'live',
  },
  {
    slug: 'color-reach',
    name: 'Color Reach',
    description: 'Reach for matching color zones with your camera! A body-movement game that teaches color recognition.',
    icon: '🎨',
    status: 'live',
  },
  {
    slug: 'jelly-wobble',
    name: 'Jelly Wobble',
    description: 'Push and squish a big friendly jelly by moving near it! Satisfying wobble physics with no wrong way to play.',
    icon: '🫠',
    status: 'live',
  },
  {
    slug: 'leaf-swirl',
    name: 'Leaf Swirl',
    description: 'Blow autumn leaves around by moving your body! Create swirling wind patterns in a zen-like nature experience.',
    icon: '🍂',
    status: 'live',
  },
  {
    slug: 'star-dash',
    name: 'Star Dash',
    description: 'Dash to catch fading stars with your body! Build streak multipliers and constellations in this fast-paced camera game.',
    icon: '⭐',
    status: 'live',
  },
]