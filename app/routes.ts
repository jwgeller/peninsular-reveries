...
export const routes = route({
  ...
  bubblePopInfo: '/bubble-pop/info/',
  colorReach: '/color-reach/',
  colorReachInfo: '/color-reach/info/',
  jellyWobble: '/jelly-wobble/',
  jellyWobbleInfo: '/jelly-wobble/info/',
  leafSwirl: '/leaf-swirl/',
  leafSwirlInfo: '/leaf-swirl/info/',
  starDash: '/star-dash/',
  starDashInfo: '/star-dash/info/',
  notFound: '/404.html',
})