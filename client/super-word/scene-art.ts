...
export const DISTRACTOR_ART: readonly ItemArt[] = [
  ...
  { emoji: '📷', label: 'Camera', zone: 'ground', scale: 0.78, themes: ['travel', 'everyday'] },
  { emoji: '✏️', label: 'Pencil', zone: 'ground', scale: 0.76, themes: ['home', 'play', 'everyday'] },
  { emoji: '🔔', label: 'Bell', zone: 'ground', scale: 0.8, themes: ['home', 'play'] },
  { emoji: '🧸', label: 'Teddy Bear', zone: 'ground', scale: 0.96, themes: ['home', 'play'] },
  { emoji: '🍂', label: 'Feather', zone: 'sky', scale: 0.68, themes: ['animals', 'nature', 'sky'] },
  { emoji: '🗿', label: 'Rock', zone: 'ground', scale: 1.08, themes: ['nature'] },
  { emoji: '🌵', label: 'Cactus', zone: 'ground', scale: 0.96, themes: ['nature'] },
  { emoji: '🌎', label: 'Planet', zone: 'sky', scale: 1.12, themes: ['space', 'travel'] },
  { emoji: '🍯', label: 'Honey', zone: 'ground', scale: 0.8, themes: ['food', 'animals'] },
  { emoji: '🎒', label: 'Backpack', zone: 'ground', scale: 0.96, themes: ['travel', 'everyday'] },
  { emoji: '❄️', label: 'Snowflake', zone: 'sky', scale: 0.66, themes: ['sky'] },
  { emoji: '🌻', label: 'Sunflower', zone: 'ground', scale: 1.08, themes: ['nature'] },
  { emoji: '🧭', label: 'Compass', zone: 'ground', scale: 0.78, themes: ['travel'] },
  { emoji: '⛵', label: 'Sailboat', zone: 'sky', scale: 0.84, themes: ['travel', 'water'] },
  { emoji: '🧁', label: 'Cupcake', zone: 'ground', scale: 0.8, themes: ['food', 'play'] },
  { emoji: '🧃', label: 'Juice Box', zone: 'ground', scale: 0.78, themes: ['food', 'everyday'] },
  { emoji: '🎯', label: 'Target', zone: 'ground', scale: 0.96, themes: ['play'] },
  { emoji: '🌺', label: 'Hibiscus', zone: 'ground', scale: 0.98, themes: ['nature'] },
  { emoji: '🍪', label: 'Cookie', zone: 'ground', scale: 0.74, themes: ['food', 'home'] },
  { emoji: '🎢', label: 'Slide', zone: 'ground', scale: 1.26, yOffset: 1, themes: ['play'] },
  { emoji: '🎨', label: 'Paint Palette', zone: 'ground', scale: 0.92, themes: ['play', 'home'] },
  { emoji: '🎵', label: 'Music Note', zone: 'sky', scale: 0.7, themes: ['play'] },
  { emoji: '⚽', label: 'Soccer Ball', zone: 'ground', scale: 0.82, themes: ['play'] },
  { emoji: '🪁', label: 'Spare Kite', zone: 'sky', scale: 0.94, themes: ['play', 'sky'] },
  { emoji: '🧊', label: 'Ice Cube', zone: 'ground', scale: 0.72, themes: ['food', 'home'] },
  { emoji: '🌈', label: 'Bright Rainbow', zone: 'sky', scale: 1.1, themes: ['sky', 'play'] },
  { emoji: '☁️', label: 'Soft Cloud', zone: 'sky', scale: 1.14, themes: ['sky'] },
  { emoji: '🌙', label: 'Crescent Moon', zone: 'sky', scale: 0.96, themes: ['space', 'sky'] },
  { emoji: '⚓', label: 'Anchor', zone: 'ground', scale: 1.04, themes: ['travel', 'water'] },
  { emoji: '🐚', label: 'Seashell', zone: 'ground', scale: 0.82, themes: ['water', 'nature'] },
  { emoji: '🍄', label: 'Mushroom', zone: 'ground', scale: 0.84, themes: ['nature'] },
  { emoji: '🪺', label: 'Nest', zone: 'ground', scale: 0.84, themes: ['animals', 'nature'] },
  { emoji: '🍓', label: 'Strawberry', zone: 'ground', scale: 0.78, themes: ['food', 'nature'] },
